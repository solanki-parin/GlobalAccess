...
{
	static const FName FloatSetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, SetFloatByName));
	static const FName IntSetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, SetIntByName));
	static const FName Int64SetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, SetInt64ByName));
	static const FName BoolSetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, SetBoolByName));
	static const FName NameSetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, SetNameByName));
	static const FName ObjectSetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, SetObjectByName));
	static const FName ClassSetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, SetClassByName));
	static const FName ByteSetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, SetByteByName));
	static const FName StringSetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, SetStringByName));
	static const FName TextSetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, SetTextByName));
	//static const FName StructSetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, SetStructByName));
	static const FName EnumSetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, SetEnumByName));
};

void USetObjectVarByName::AllocateDefaultPins()
{
...
void USetObjectVarByName::PinDefaultValueChanged(UEdGraphPin * Pin)
{
	if (Pin)
	{
...
FText USetObjectVarByName::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
	return LOCTEXT("SetObjVarByNameK2Node_Title", "Set Object Variable By Name");
}

FText USetObjectVarByName::GetTooltipText() const
{
...
FText USetObjectVarByName::GetMenuCategory() const
{
...
void USetObjectVarByName::ExpandNode(class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
...
void USetObjectVarByName::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
...
void USetObjectVarByName::NotifyPinConnectionListChanged(UEdGraphPin * Pin)
{
...
UEdGraphPin * USetObjectVarByName::GetThenPin() const
{
	const UEdGraphSchema_K2* K2Schema = GetDefault<UEdGraphSchema_K2>();
...
UEdGraphPin * USetObjectVarByName::GetTargetPin() const
{
...
UEdGraphPin * USetObjectVarByName::GetVarNamePin() const
{
...
UEdGraphPin * USetObjectVarByName::GetNewValuePin() const
{
...
UEdGraphPin * USetObjectVarByName::GetReturnResultPin() const
{
...
UEdGraphPin * USetObjectVarByName::GetReturnValuePin() const
{
...
void USetObjectVarByName::CoerceTypeFromPin(const UEdGraphPin * Pin, bool bWasNewValuePin)
{
...
//find setter
UFunction * USetObjectVarByName::FindSetterFunctionByType(FEdGraphPinType& PinType)
{
