...
#include "GetObjectVarByName.h"
#include "GlobalAccess/PropertyAccess/FunctionLibrary/PropertyFunctions.h"
...
#define LOCTEXT_NAMESPACE "GetObjectVarByName"
...
{
	static const FName FloatGetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, GetFloatByName));
	static const FName IntGetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, GetIntByName));
	static const FName Int64GetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, GetInt64ByName));
	static const FName BoolGetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, GetBoolByName));
	static const FName NameGetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, GetNameByName));
	static const FName ObjectGetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, GetObjectByName));
	static const FName ClassGetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, GetClassByName));
	static const FName ByteGetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, GetByteByName));
	static const FName StringGetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, GetStringByName));
	static const FName TextGetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, GetTextByName));
	//static const FName StructGetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, GetStructByName));
	//static const FName EnumGetterName(GET_FUNCTION_NAME_CHECKED(UPropertyFunctions, GetEnumByName));
};
...
namespace
{
	...
	struct FGetObjectVarOptionalPinManager : public FOptionalPinManager
	{
		...
		{
			SrcClass = InClass;
			bExcludeObjectArrayProperties = bExcludeObjectContainers || bExcludeObjectArrays;// added another | revode if needed
	...
	public:
		...
		virtual void RegisterNets(FKismetFunctionContext& Context, UEdGraphNode* Node) override
		{
			...
			if (const UGetObjectVarByName* GetObjectVarNode = Cast<UGetObjectVarByName>(Node))
			{
...
//UObject interface
void UGetObjectVarByName::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UGetObjectVarByName::PreEditChange(UProperty* PropertyThatWillChange)
{
...
void UGetObjectVarByName::AllocateDefaultPins()
{
...
void UGetObjectVarByName::PostPlacedNewNode()
{
...
void UGetObjectVarByName::PinDefaultValueChanged(UEdGraphPin * Pin)
{
...
void UGetObjectVarByName::PinConnectionListChanged(UEdGraphPin* ChangedPin)
{
...
FText UGetObjectVarByName::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
	return LOCTEXT("GetObjVarByNameK2Node_Title", "Get Object Variable By Name");
}

FText UGetObjectVarByName::GetTooltipText() const
{
...
FText UGetObjectVarByName::GetMenuCategory() const
{
...
void UGetObjectVarByName::ReallocatePinsDuringReconstruction(TArray<UEdGraphPin*>& OldPins)
{
...
bool UGetObjectVarByName::HasExternalDependencies(TArray<class UStruct*>* OptionalOutput) const
{
...
FNodeHandlingFunctor* UGetObjectVarByName::CreateNodeHandler(FKismetCompilerContext& CompilerContext) const
{
	return new FKCHandler_GetObjectVar(CompilerContext);
}

void UGetObjectVarByName::ExpandNode(class FKismetCompilerContext& CompilerContext, UEdGraph* SourceGraph)
{
...
void UGetObjectVarByName::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
...
void UGetObjectVarByName::NotifyPinConnectionListChanged(UEdGraphPin * Pin)
{
...
void UGetObjectVarByName::ValidateNodeDuringCompilation(class FCompilerResultsLog& MessageLog) const
{
...
UEdGraphPin * UGetObjectVarByName::GetThenPin() const
{
	const UEdGraphSchema_K2* K2Schema = GetDefault<UEdGraphSchema_K2>();
...
UEdGraphPin * UGetObjectVarByName::GetTargetPin() const
{
...
UEdGraphPin * UGetObjectVarByName::GetVarNamePin() const
{
...
UEdGraphPin * UGetObjectVarByName::GetReturnResultPin() const
{
...
UEdGraphPin * UGetObjectVarByName::GetReturnValuePin() const
{
	if (Pins.Num() > 5)
	{
...
FEdGraphPinType& UGetObjectVarByName::GetReturnValueType() const
{
	if (Pins.Num() > 5)
	{
...
///Node type handling
/*
void GetObjectVarByName::CoerceTypeForPin(const UEdGraphPin * Pin)
{
	UEdGraphPin* OutValuePin = GetReturnValuePin();
...
//find setter
UFunction * UGetObjectVarByName::FindGetterFunctionByType(FEdGraphPinType& PinType)
{
	UClass* LibraryClass = UPropertyFunctions::StaticClass();
...
UClass* UGetObjectVarByName::GetInputClass(const UEdGraphPin* FromPin) const
{
...
void UGetObjectVarByName::OnBlueprintClassModified(UBlueprint* TargetBlueprint)
{
...
void UGetObjectVarByName::CreateOutputPins(UClass* InClass)
{
...
void UGetObjectVarByName::OnClassPinChanged()
{
	Modify();
...
void UGetObjectVarByName::OnVarNamePinChanged()
{
	Modify();
...
void UGetObjectVarByName::UpdateShowPinForProperties()
{
...
bool UGetObjectVarByName::CheckVarExists(FOptionalPinFromProperty& Prop, UStruct * InClass)
{
	bool Out = false;
